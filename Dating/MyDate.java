...
public class MyDate implements DateInterface /*using implements since i'm using 
...
of the class i'm extending)*/
{
	...
	/*month the month of the year (0-11)
	  day the day the month (1-31)
	  year the year (four digits)
	  dow the day of the week (0-6) */
